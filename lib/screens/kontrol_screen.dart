  ...
  Widget build(BuildContext context) {
    ...
    return ListView(padding: const EdgeInsets.all(14), children: [
        ...
        child: Row(children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(
                blackout ? Icons.power_off : Icons.power,
                color: blackout ? Colors.redAccent : Colors.greenAccent,
                size: 22,
              ),
            ),
      ...
      _Kart(baslik: '🎛️ Kontroller', child: Column(children: [
        ...
        const SizedBox(height: 6),
        _Slider(
          ikon: Icons.swap_vert, etiket: 'Dikey Pos',
      ...
      _Kart(baslik: '🔄 Yön & Döndürme', child: Column(children: [
        ...
        Row(children: [
          ...
          const SizedBox(width: 6),
          Expanded(child: _Btn(
            etiket: textSize == 1 ? '🔤 Boyut: 1x' : '🔠 Boyut: 2x',
            renk: Colors.deepPurple,
            tiklandi: () => svc.send({'textSize': textSize == 1 ? 2 : 1}))),
        ]),
      ])),
      const SizedBox(height: 10),
      ...
      _Kart(baslik: '📋 Playlist', child: Column(children: [
        ...
        if (playlist) ...[
          ...
          _Slider(
            ikon: Icons.timer,
            etiket: 'Süre (sn)',
            deger: ((s['playInterval'] ?? 5) as num).toDouble(),
            min: 1, max: 60, renk: Colors.teal,
